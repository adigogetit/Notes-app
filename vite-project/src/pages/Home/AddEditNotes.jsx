    ...
    return (
        <div className='relative'>
            ...
            <div className='flex flex-col gap-2'>
                <label className='input-lable m-1 '>TITLE</label>
                <input
                    type="text"
                    className=" p-2 text-xl text-slate-950 border rounded ouline-none"
            ...
            <div className='flex flex-col gap-2 mt-4'>
                ...
                <textarea
                    type="text"
                    className=" text-sm text-slate-950 ouline-none border mb-1 bg-slate-50 p-2 rounded"
